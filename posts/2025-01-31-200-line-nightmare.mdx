...
summary:
  "Turned a messy 200-line SQL query nightmare into a 10x performance win.
  Here's how I optimized database queries, separated concerns, and made the code actually maintainable."
---
